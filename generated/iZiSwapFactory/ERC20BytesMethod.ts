...
export class ERC20BytesMethod extends ethereum.SmartContract {
  static bind(address: Address): ERC20BytesMethod {
    return new ERC20BytesMethod("ERC20BytesMethod", address);
  }
